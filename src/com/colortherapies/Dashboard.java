...
public class Dashboard extends Activity {
	...
	ArrayList<View> career_array_view, health_array_view, finance_array_view,
			relation_array_view;
	BaseAdapter adpt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		acc_prefs = new AccountPreference(this);

		Log.d("ARR", "Dash fresh :" + acc_prefs.getBool("isFreshInstall"));
		Log.d("ARR", "Dash Username :" + acc_prefs.get("username"));

		Typeface helvetica = Typeface.createFromAsset(getAssets(),
				"font/Helvetica Neue UltraLight.ttf");
		 ...
		 * menuArray.add("Prediction for Next Week"); menuArray.add("Settings");
		 * 
